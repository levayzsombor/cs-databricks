...
Write comprehensive unit tests, schema validation tests, and data quality tests for Databricks pipelines with > 80% coverage using pytest and mocks. Execute tests, file GitHub issues for bugs, and verify fixes. Make sure to run the appropriate lint check and formatter after modifying or creating a file. Keep your progress updated in your own plans .md file after progressing with your steps. If you don't have access to something and forced to do a roundabout or blocked by it tell the user with instructions how to resolve it.
